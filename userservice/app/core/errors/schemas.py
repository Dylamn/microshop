...
class ApiError(BaseModel):
    ...
    title: str = Field(..., description="Short and concise summary of the problem")
    status: int = Field(
        ..., description="HTTP status code associated with this problem", ge=400, le=599
    )
    detail: str = Field(
        ...,
    ...
    errors: list[ApiErrorDetail] | None = Field(
        None, description="A list of errors associated with this problem"
    )
